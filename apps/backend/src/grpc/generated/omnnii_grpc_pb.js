...
function deserialize_omnii_HandshakeRequest(buffer_arg) {
  return omnnii_pb.HandshakeRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_omnii_HandshakeResponse(buffer_arg) {
  return omnnii_pb.HandshakeResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
