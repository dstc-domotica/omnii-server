...
interface IOmniiServiceService_IHandshake extends grpc.MethodDefinition<omnnii_pb.HandshakeRequest, omnnii_pb.HandshakeResponse> {
...
export interface IOmniiServiceServer extends grpc.UntypedServiceImplementation {
    ...
    handshake: grpc.handleUnaryCall<omnnii_pb.HandshakeRequest, omnnii_pb.HandshakeResponse>;
...
export interface IOmniiServiceClient {
    ...
    handshake(request: omnnii_pb.HandshakeRequest, callback: (error: grpc.ServiceError | null, response: omnnii_pb.HandshakeResponse) => void): grpc.ClientUnaryCall;
    handshake(request: omnnii_pb.HandshakeRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: omnnii_pb.HandshakeResponse) => void): grpc.ClientUnaryCall;
    handshake(request: omnnii_pb.HandshakeRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: omnnii_pb.HandshakeResponse) => void): grpc.ClientUnaryCall;
...
export class OmniiServiceClient extends grpc.Client implements IOmniiServiceClient {
    ...
    public handshake(request: omnnii_pb.HandshakeRequest, callback: (error: grpc.ServiceError | null, response: omnnii_pb.HandshakeResponse) => void): grpc.ClientUnaryCall;
    public handshake(request: omnnii_pb.HandshakeRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: omnnii_pb.HandshakeResponse) => void): grpc.ClientUnaryCall;
    public handshake(request: omnnii_pb.HandshakeRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: omnnii_pb.HandshakeResponse) => void): grpc.ClientUnaryCall;
